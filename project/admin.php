            ...
            <tr>
              ...
              <td class="button"> 
                  <form action="" method="POST"> 
                    ...
                    <button class="btn btn-info" name="view" type ="submit"> View Details</button>
                   </form>
                  <form action="" method="POST"> 
                      <input type="hidden" name="user_id" value="<?php echo $row['id']; ?>">
                    <button class="btn btn-primary" name="book" type ="submit"> Appointment</button>
                  </form>
                  <form action="" method="POST"> 
                       <input type="hidden" name="userid" value="<?php echo $row['id']; ?>">
                    <button class="btn btn-warning" name="addp" type ="submit"> Prescription</button>
                   </form>
             </td>
            </tr>
         <?php } }
